...
#> Database: file1d44286b4bae.duckdb
#> Registered tables: 1
#>   table_name source_type    geom_type  crs row_count          created_at
#> 1    sa4_vic          sf MULTIPOLYGON 7844        17 2026-06-09 20:54:05
```
...
#> Output file: file1d4437ec403b.gpkg
```
...
#> Registered tables: 2
#>       table_name source_type    geom_type  crs row_count          created_at
#> 1 sa4_vic_points          sf        POINT 7844        17 2026-06-09 20:54:08
#> 2        sa4_vic          sf MULTIPOLYGON 7844        17 2026-06-09 20:54:05
```
