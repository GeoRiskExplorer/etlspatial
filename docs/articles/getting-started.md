...
#> Database: file25547d271d2e.duckdb
#> Registered tables: 1
#>   table_name source_type    geom_type  crs row_count          created_at
#> 1    sa4_vic          sf MULTIPOLYGON 7844        17 2026-06-08 23:51:27
```
...
#> Output file: file255455f7a73.gpkg
```
...
#> Registered tables: 2
#>       table_name source_type    geom_type  crs row_count          created_at
#> 1 sa4_vic_points          sf        POINT 7844        17 2026-06-08 23:51:30
#> 2        sa4_vic          sf MULTIPOLYGON 7844        17 2026-06-08 23:51:27
```
