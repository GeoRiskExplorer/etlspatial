...
The package focuses on reliable movement of spatial data between GIS
formats, analytical databases, and R spatial environments while
preserving geometry integrity, CRS consistency, and reproducible
...
The package is designed for analysts, GIS practitioners, and spatial
data scientists working with operational or large spatial datasets in
